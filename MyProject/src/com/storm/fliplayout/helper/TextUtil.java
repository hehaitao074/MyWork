...
import com.storm.fliplayout.appliancation.MyApplication;
...
public class TextUtil {
	...
	public static String getIdFromUrl(String url, String ignoreTag) {
		if (TextUtils.isEmpty(url) || (!TextUtils.isEmpty(ignoreTag))
	 ...
	 * @param textWatcher
	 */
	public static void cleanPasswordEditText(final EditText editText,
